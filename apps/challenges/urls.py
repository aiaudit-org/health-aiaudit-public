...
urlpatterns = [
    ...
    url(
        ...
        url(
        r"^questionnaire/submission/$",
        views.challenge_questionnaire_submit,
        name="challenge_questionnaire_submit",
    ),
    url(
        r"^(?P<challenge_id>[0-9]+)/(?P<team_id>.*)/questionnaire/$",
        views.get_challenge_questionnaire,
        name="get_challenge_questionnaire",
    ),
]
