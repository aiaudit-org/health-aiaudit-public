...
def has_questionnaire_this_challenge(challenge_id, team_id):
    questionnaire = ChallengeQuestionnaire.objects.filter(challenge_id=request.data.get("challenge_id"),team_id=request.data.get("team_id"))
