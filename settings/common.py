...
API_HOST_URL = os.environ.get("API_HOST_URL", "health.aiaudit.org")
...
# new attempt to fix the static migrate issue
# see https://stackoverflow.com/questions/41807778/django-storages-amazon-s3-giving-400-bad-request-exception
